...
export default function Section02() {
    return (
        <div className='px-4 lg:pt-16 pt-8 space-y-12 lg:space-y-0 lg:px-16 grid-cols-7 lg:grid grid-flow-row'>
            <div className='col-span-4 space-y-4 lg:pr-16'>
                <div className='space-y-4'>
                    <p className='text-3xl lg:text-7xl'>Started from the bottom now we are here</p>
                ...
                <div className='space-y-4'>
                    <p className='text-3xl lg:text-7xl'>This is our story and its not over yet</p>
                    <p className='font-sans font-semibold  text-justify'>
